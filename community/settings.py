...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-cqwc3_!!43rv8!9mems5m*5*!l5)v_k*n%g9hj4gc21wecv44n')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DEBUG', 'False').lower() == 'true'

# Updated ALLOWED_HOSTS to include the specific deploy.tz domain
ALLOWED_HOSTS_STR = os.getenv('ALLOWED_HOSTS', 'aru-tech-community.deploy.tz')
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'commune/static')]
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# WhiteNoise settings for static files (using simpler storage for compatibility)
